    ...
    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
        ...
        <div class="w-full card p-5">
            <div class="w-full lg:border-r border border-r-gray-300 rounded-md flex flex-col justify-end item-center p-4">
                <div class="w-full h-[10vh]  grid grid-cols-7 place-items-center text-end flex justify-center item-start space-x-5 mb-10">
                    <div
...
<script type="text/javascript">
    ...
    for(var x = 0; x < getstrs.length; x++){
     ...
     getstrs[x].innerHTML = str.substring(0,200).concat(' See more...')
