    ...
    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
        ...
        <div class="w-full card p-5">
            <div class="w-full lg:border-r border border-r-gray-300 rounded-md flex flex-col justify-end item-center p-4">
                <div class="w-full h-[10vh] overflow-y-scroll grid grid-cols-7 place-items-center text-end flex justify-center item-start space-x-5 mb-10">
                    <div
                        class="w-[50px] h-[50px] border bg-gray-100 flex justify-start items-center  overflow-hidden bg-blue-00 transform rounded-full">
...
<script type="text/javascript">
    let getstr = document.querySelector('.wish-string');
    console.log(getstr.innerHTML)
</script>